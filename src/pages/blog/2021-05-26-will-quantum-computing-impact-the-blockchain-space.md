...
Orchid brings together the capabilities of many leading VPN providers through a unique, decentralized privacy marketplace. Orchid's native digital currency, [OXT](https://www.orchid.com/oxt/), and innovative payments system known as [probabilistic nanopayments](https://medium.com/orchid-labs/probabilistic-nanopayments-4aa423c3f22f) mean Orchid users can rely on [fast](/orchid-just-got-faster/), consistent connections and download speeds, as well as abundant bandwidth on the network.

Users pay for bandwidth on Orchid on a pay-as-you-go basis -- there are no monthly fees or minimums, so you don't pay for what you don't use. People can get started on Orchid for [as little as $1](/starting-today-it-only-costs-1-to-get-started-with-orchid/), and through [in-app purchases](/why-orchids-in-app-purchases-are-a-game-changer-for-dapp-usage/), set up an Orchid account with nothing more than an ordinary credit card. By making privacy affordable, accessible, and fast, Orchid's decentralized VPN network is helping reclaim the Internet as a place of freedom and curiosity.
