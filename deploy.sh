...
if [ "$1" == "staging" ] && [ "${#2}" == "2" ]; then
    copy-push "ssh://git-codecommit.us-west-2.amazonaws.com/v1/repos/blog.${2}.orchid.dev"
elif [ "$1" == "staging" ]; then
    copy-push 'ssh://git-codecommit.us-west-2.amazonaws.com/v1/repos/blog.orchid.dev'
elif [ "$1" == "production" ] && [ "${#2}" == "2" ]; then
    copy-push "ssh://git-codecommit.us-west-2.amazonaws.com/v1/repos/blog.${2}.orchid.com"
elif [ "$1" == "production" ]; then
    copy-push 'ssh://git-codecommit.us-west-2.amazonaws.com/v1/repos/blog.orchid.com'
fi
